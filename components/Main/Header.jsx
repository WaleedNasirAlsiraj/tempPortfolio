      ...
      <motion.div
        ...
        >
          <div className="flex flex-col gap-3">
            <h1 className="text-4xl lg:text-7xl font-semibold">I’m Brian Do</h1>
            <p className="text-secondary-foreground/70 text-lg lg:text-3xl">
              Product designer from Jakarta, ID. <br /> Currently designing at
              Rectangle.
            </p>
          ...
          <div className=" h-full justify-center items-center flex ">
            <div>
              <img
                ...
                className="size-56 lg:size-96 border-2 border-secondary-foreground/10 p-2 rounded-full"
              />
            </div>
          </div>
        </motion.div>
